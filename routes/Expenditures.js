...
router.post('/addexpenditure', (req, res, next) => {
    connection.query(`INSERT into Expenditures(EDate,EmpID,WSID,SSID,EAmount) values('${req.body.EDate}',${req.body.EmpID},${req.body.WSID},${req.body.SSID},${req.body.EAmount})`, function (err, result) {
        if(err){
            res.status(500).json({ message: err.toString() });
            return;
        } 
